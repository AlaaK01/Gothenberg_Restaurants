...
export default function RestaurantDetailsVariant2(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "RestaurantDetailsVariant2")}
      {...rest}
    >
      <Flex
        gap="32px"
      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 736472792")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Divider36472795")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 736472796")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Divider36472799")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 736472800")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      <Divider
        ...
        {...getOverrideProps(overrides, "Divider36472803")}
      ></Divider>
    </Flex>
  );
}
