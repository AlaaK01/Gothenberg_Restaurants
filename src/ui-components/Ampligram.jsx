...
export default function Ampligram(props) {
  const { restautantDetails, overrides, ...rest } = props;
  return (
    <Flex
      gap="8px"
      direction="column"
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Phone:  "}${restautantDetails?.phone}`}
      ...
      <Image
        ...
        padding="0px 0px 0px 0px"
        objectFit="cover"
        src={restautantDetails?.imageUrl}
      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={restautantDetails?.name}
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={restautantDetails?.description}
            {...getOverrideProps(
              overrides,
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={restautantDetails?.menu}
